...
/* package hqdm-0.1.0.0 */
#ifndef VERSION_hqdm
#define VERSION_hqdm "0.1.0.0"
#endif /* VERSION_hqdm */
#ifndef MIN_VERSION_hqdm
#define MIN_VERSION_hqdm(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_hqdm */
...
#define CURRENT_PACKAGE_KEY "hqdm-0.1.0.0-6gDarUBODDiJQFhFfB4XPK"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "hqdm-0.1.0.0-6gDarUBODDiJQFhFfB4XPK"
