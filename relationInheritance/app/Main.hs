...
hqdmRelationsInputFilename = "../PureHqdmRelations_v7.csv" -- allHqdmRels or exportedPureBinaryRelationsModded2 or PureHqdmRelations_v0 or ...

hqdmInputFilename::String
hqdmInputFilename = "./input/HqdmAllAsDataFormal4.csv"  -- hqdmAllAsDataFormal1_NoExtensions or hqdmAllAsDataFormal1 or hqdmAllAsDataFormal4 or ...
