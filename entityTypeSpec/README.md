...
`entityTypeSpec -a PureHqdmRelations_v5.csv HqdmAllAsDataFormal3Short.csv spatio_temporal_extent`

or

`entityTypeSpec -a PureHqdmRelations_v5.csv HqdmAllAsDataFormal3Short.csv dd8359c4-0a2b-416a-af27-3bcb0551b41a`
...
`./entityTypeSpec -ac PureHqdmRelations_v5.csv HqdmAllAsDataFormal3Short.csv spatio_temporal_extent`
...
`stack exec -- entityTypeSpec -a PureHqdmRelations_v5.csv HqdmAllAsDataFormal3Short.csv functional_system`
