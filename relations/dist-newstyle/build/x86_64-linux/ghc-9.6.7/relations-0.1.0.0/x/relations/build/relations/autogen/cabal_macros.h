...
/* package relations-0.1.0.0 */
#ifndef VERSION_relations
#define VERSION_relations "0.1.0.0"
#endif /* VERSION_relations */
#ifndef MIN_VERSION_relations
#define MIN_VERSION_relations(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_relations */
...
/* package network-info-0.2.1 */
#ifndef VERSION_network_info
#define VERSION_network_info "0.2.1"
...
#define CURRENT_COMPONENT_ID "relations-0.1.0.0-inplace-relations"
